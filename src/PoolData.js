...
import { assertConstrData, expectIntData, unwrapUplcDataOption } from "@helios-lang/uplc"
...
export function convertUplcDataToPoolData(datum) {
    ...
    let feeSharing = feeSharingData ? expectIntData(feeSharingData).value : undefined
